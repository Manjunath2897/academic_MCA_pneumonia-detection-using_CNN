...
class Ui_MainWindow(object):
    ...
    def retranslateUi(self, MainWindow):
        ...
        self.label_2.setText(_translate("MainWindow", "Leaf Detection"))
    ...
    def classifyFunction(self):
        ...
        label = ["normal","pneumonia","Gray_Leaf_Spot","Healthy"]
        # label=["fifty","fivehundred","hundred","ten","twenty","twohundred"]
        path2 = self.file
        print(path2)
        test_image = image.load_img(path2, target_size=(400, 400))
